      ...
      13695: (e, t, s) => {
        ...
        class te {
          ...
          update(e) {
            ...
            if (this.game.bullets) {
              this.game.bullets.forEach((b, i) => {
                b.y -= 20 * this.game.time.scale; // Move bullet up (backwards relative to surfer)
                if (b.y < -100) {
        ...
        class de {
          ...
          drawPlayerSprite(e, t = 0, s = 0, i = 0, a = 1) {
            ...
            this.drawBullets(s, i, a);
          }
          drawBullets(px, py, scale) {
            if (te.sys.game.bullets) {
              const ctx = this.ctx;
              te.sys.game.bullets.forEach(b => {
                let sx = px + b.x * scale;
                let sy = py + b.y * scale;
                ctx.fillStyle = "red";
                ctx.fillRect(sx, sy, b.w * scale, b.h * scale);
              });
            }
          }
