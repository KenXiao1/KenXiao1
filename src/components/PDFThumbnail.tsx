...
export default function PDFThumbnail({ filename, title }: PDFThumbnailProps) {
  ...
  return (
    <div className="aspect-[3/4] bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden group-hover:from-gray-200 group-hover:to-gray-300 dark:group-hover:from-gray-700 dark:group-hover:to-gray-800 transition-all duration-300">
      {!showFallback && (
        <iframe
          src={`${pdfUrl}#page=1&view=FitH&toolbar=0&navpanes=0&scrollbar=0&statusbar=0&messages=0`}
